-- AWR KEY SYSTEM v3 — PASTE DI SUPABASE SQL EDITOR → RUN
-- Aman dijalankan berkali-kali, tidak hapus data yang ada
...
RETURNS void AS $$ BEGIN UPDATE users SET total_executions=COALESCE(total_executions,0)+1 WHERE id=user_id; END; $$ LANGUAGE plpgsql SECURITY DEFINER;
